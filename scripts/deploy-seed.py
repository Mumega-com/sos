...
INKWELL_EXAMPLES_DIR = Path("/home/sos/inkwell/examples") if Path("/home/sos/inkwell/examples").exists() else Path("/home/sos/mumega.com/examples") if Path("/home/sos/mumega.com/examples").exists() else None
...
def deploy_seed(
    ...
    try:
        active_path = Path("/home/sos/SOS/sos/brain/active_projects.json")
    ...
    try:
        sources_dir = Path(f"/home/sos/SOS/projects/{project_id}")
    ...
    try:
        ...
        seed_path = Path(f"/home/sos/SOS/projects/{project_id}/seed.json")
