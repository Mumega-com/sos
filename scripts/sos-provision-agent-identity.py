...
Example:
  ...
  python3 scripts/sos-provision-agent-identity.py kasra /home/sos
  python3 scripts/sos-provision-agent-identity.py mumcp /home/sos/projects/sitepilotai
"""
...
def _update_tokens_json(agent: str, token_hash: str) -> None:
    ...
    write_tokens_atomic(TOKENS_FILE, tokens)
