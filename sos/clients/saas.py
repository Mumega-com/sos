...
The SaaS admin API is admin-key-gated. The client reads scoped admin env
vars and does not fall back to the mesh break-glass token.
"""
...
def _admin_headers(token: Optional[str]) -> Dict[str, str]:
    key = (
        ...
        or os.environ.get("SOS_SAAS_TOKEN")
