...
WEB_APP_URL = os.environ.get("DISCORD_WEB_APP_URL", os.environ.get("SOS_WEB_APP_URL", ""))
WEBHOOKS_PATH = Path(os.environ.get("DISCORD_WEBHOOKS_PATH", str(Path.home() / ".sos" / "discord_webhooks.json")))
