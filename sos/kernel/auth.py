...
_ENV_TOKENS: tuple[tuple[str, bool, tuple[str, ...]], ...] = (
    ...
    ("SOS_MCP_TOKEN", False, ("mcp:*", "bus:*", "squad:*")),
    ("SOS_DOCS_TOKEN", False, ("docs:*",)),
    ("SOS_REGISTRY_TOKEN", False, ("registry:*",)),
    ("SOS_SAAS_TOKEN", False, ("saas:*",)),
    ("SOS_SQUAD_TOKEN", False, ("squad:*", "bus:send")),
    ("SOS_BILLING_TOKEN", False, ("billing:*",)),
    ("SOS_INTEGRATIONS_TOKEN", False, ("integrations:*",)),
    ("SOS_HEALTH_TOKEN", False, ("health:*", "squad:read")),
    ("SOS_MATCHMAKER_TOKEN", False, ("squad:*",)),
    ("SOS_OPERATIONS_TOKEN", False, ("operations:*",)),
    ("SOS_JOURNEYS_TOKEN", False, ("journeys:*",)),
    ("SOS_IDENTITY_TOKEN", False, ("identity:*",)),
    ("SOS_OBJECTIVES_TOKEN", False, ("objectives:*",)),
    ("SOS_ECONOMY_TOKEN", False, ("economy:*",)),
    ("SOS_GLASS_SYSTEM_TOKEN", False, ("glass:*",)),
    ("SOS_MEMORY_TOKEN", False, ("memory:*",)),
)
