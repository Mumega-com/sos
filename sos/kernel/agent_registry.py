...
AGENTS: dict[str, AgentDef] = {
    ...
    "kasra": AgentDef(
        ...
        session="kasra",
        restart_cmd='codex --model gpt-5.3-codex-spark --sandbox danger-full-access -c approval_policy="never"',
        skills=("backend", "frontend", "infrastructure", "api", "database", "typescript", "python"),
        idle_patterns=("›", "❯", "$ ", "Use /skills"),
        busy_patterns=("Transmuting", "Churning", "Baking", "Warping", "Thinking", "Running"),
    ...
    "athena": AgentDef(
        ...
        busy_patterns=("Thinking", "Writing", "Transmuting", "Churning", "Running"),
        compaction_patterns=("Auto-compact", "context window", "Compacting"),
        max_concurrent=2,
        warm_policy=WarmPolicy.WARM,
    ),
    ...
    "codex": AgentDef(
        ...
        role=AgentRole.SPECIALIST,
        session="codex",
        restart_cmd='codex --model gpt-5.4 --sandbox danger-full-access -c approval_policy="never"',
    ...
    # Home: /home/sos/mumega.com/agents/loom/
    "loom": AgentDef(
        name="loom",
        type=AgentType.TMUX,
        role=AgentRole.COORDINATOR,
        ...
        idle_patterns=("›", "❯", "$ ", "Use /skills"),
        busy_patterns=("Thinking", "Writing", "Weaving", "Synthesizing", "Running"),
        compaction_patterns=("Auto-compact", "context window", "Compacting"),
        max_concurrent=2,
        warm_policy=WarmPolicy.WARM,
    ),
