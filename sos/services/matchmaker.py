...
Env vars:
  ...
  SOS_MATCHMAKER_TOKEN     — auth token for Squad Service API calls
...
SOS_MATCHMAKER_AUTH_TOKEN = (
    os.environ.get("SOS_MATCHMAKER_TOKEN")
...
_HEADERS = {
    'Authorization': f'Bearer {SOS_MATCHMAKER_AUTH_TOKEN}',
