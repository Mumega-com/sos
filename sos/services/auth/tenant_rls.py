...
LOCK-5: App MUST connect as the configured application role (PG RLS is bypassed
for superuser).
...
APP_DB_ROLE = os.getenv("SOS_APP_DB_ROLE", "sos_app_role")
