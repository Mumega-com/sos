...
# ---------------------------------------------------------------------------
# 12. env_token — SOS_OBJECTIVES_TOKEN only
# ---------------------------------------------------------------------------


def test_env_token_uses_objectives_token(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setenv("SOS_OBJECTIVES_TOKEN", "objectives-token")
    ...
    assert captured["auth"] == "Bearer objectives-token"
