...
uv run python -m py_compile \
  /home/sos/SOS/sos/contracts/squad.py \
  /home/sos/SOS/sos/mcp/sos_mcp_sse.py \
  /home/sos/SOS/sos/services/health/lifecycle.py \
  /home/sos/SOS/sos/services/squad/service.py
```
...
```bash
uv run python -m pytest /home/sos/SOS/tests/test_lifecycle_contract.py -q
```
...
```bash
uv run --with redis --with requests python -m pytest /home/sos/SOS/tests/test_lifecycle_contract.py -q
```
...
uv run --with requests python -m pytest \
  /home/sos/SOS/tests/test_lifecycle_contract.py \
  /home/sos/SOS/tests/test_mcp_cloudflare_auth.py \
  /home/sos/SOS/tests/test_squad_runtime.py -q
```
