...
- File: `/home/sos/inkwell/kernel/adapters/glass/sos.ts` (new, Inkwell repo)
...
- Outcome: vitest test in `/home/sos/inkwell/tests/kernel/adapters/glass.test.ts` with a MSW fetch mock.

### Step 6.7 — `/dashboard` Astro route in Inkwell template

- File: `/home/sos/inkwell/instances/_template/pages/dashboard.astro` (new)
...
- File: `/home/sos/inkwell/instances/_template/glass.json` (new) — empty array placeholder with a commented example.
