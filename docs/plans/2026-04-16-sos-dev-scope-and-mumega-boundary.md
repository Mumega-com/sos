...
**Companion to:** `/home/sos/docs/plans/2026-04-16-app-mumega-dashboard.md` (Kasra)
...
- Fixed SEC-001 auth regression in `sos/services/dashboard/app.py` + `/home/sos/mirror/mirror_api.py`
