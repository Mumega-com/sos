...
**Reference impl:** `/home/sos/mirror/mirror_bus_consumer.py` (separate Mirror repo; see also `systemctl --user status mirror_bus_consumer.service`).
...
```python
# pseudocode — see /home/sos/mirror/mirror_bus_consumer.py for reference
import asyncio
...
- `/home/sos/mirror/mirror_bus_consumer.py` — reference implementation (separate Mirror repo)
- `/home/sos/mirror/mirror_bus_consumer.service` — systemd --user unit (reference)
