...
MIRROR_TOKEN = os.getenv("MIRROR_TOKEN") or os.getenv("MIRROR_ADMIN_TOKEN", "")
...
DISCORD_SCRIPT = os.getenv("DISCORD_SCRIPT", "/home/sos/scripts/discord-reply.sh")

SOVEREIGN_DATA_DIR = os.getenv("SOVEREIGN_DATA_DIR", str(Path.home() / ".mumega"))
SOVEREIGN_SQUADS_DIR = os.getenv("SOVEREIGN_SQUADS_DIR", "/home/sos/SOS/sovereign/.squads")
SOVEREIGN_PLANS_DIR = os.getenv("SOVEREIGN_PLANS_DIR", "/home/sos/SOS/sovereign/.plans")
