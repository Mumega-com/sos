...
PROGRESS_FILE = Path("/home/sos/.mumega/loop_progress.txt")
REPLY_CURSOR_FILE = Path("/home/sos/.mumega/loop_reply_cursor.txt")
...
AVAILABLE_TOOLS = {
    "scan_google_maps": {
        ...
        "script": "/home/sos/scripts/scan-google-maps.py",
    ...
    "post_discord": {
        ...
        "script": "/home/sos/scripts/discord-reply.sh",
...
def execute_scan(task: dict) -> dict:
    ...
    scan_script = Path("/home/sos/SOS/sos/agents/dandan/google_maps.py")
...
Return ONLY the message text.""")
    ...
    if text:
        ...
        subprocess.run(
            ["bash", "/home/sos/scripts/discord-reply.sh", agent, "control",
...
_OPENROUTER_BLOCK_FILE = Path("/home/sos/.mumega/openrouter_blocked_until.txt")
...
def daemon(interval_minutes: int = 10):
    ...
    subprocess.run(
        ["bash", "/home/sos/scripts/discord-reply.sh", "brain", "control",
...
if __name__ == "__main__":
    ...
    load_dotenv("/home/sos/dentalnearyou/.env", override=False)
    register_squad_skills()
